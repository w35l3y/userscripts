...
// @include        https://www.neopets.com/process_petpetlab.phtml
// @grant          GM_log
// @grant          GM_getValue
// @grant          GM_setValue
// @grant          GM_openInTab
// @grant          GM_xmlhttpRequest
// @icon           https://gm.wesley.eti.br/icon.php?desc=36224
// ==/UserScript==
...
(function () {
  ...
  var petpet = document.evaluate(
    '//img[contains(@src,"https://images.neopets.com/items/")]/@src',
    document,
    null,
    XPathResult.STRING_TYPE,
    null
  ...
  if (queueEvents.length > 0) {
    ...
    resourceText(
      "https://neopets.wesley.eti.br/PetpetLaboratory/addEvent.php?type=json",
      function (r) {
      ...
      },
      {
        ...
        events: queueEvents.toSource().replace(/(\w+):"/g, '"$1":"'),
      }
    );
  }
})();
