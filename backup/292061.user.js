...
// @icon           https://gm.wesley.eti.br/icon.php?desc=292061
    ...
    var urn = "urn:" + obj.service.urn + ":service:" + obj.service.name + ":1",
      ...
      xhr = GM_xmlhttpRequest({
        ...
        url:
          ...
          obj.service.name,
        data:
          '<?xml version="1.0" encoding="utf-8"?><s:Envelope s:encodingStyle="https://schemas.xmlsoap.org/soap/encoding/" xmlns:s="https://schemas.xmlsoap.org/soap/envelope/"><s:Body><u:' +
          obj.action +
          ' xmlns:u="' +
          urn +
          '">' +
...
SamsungTV.prototype = {
  ...
  set SHARPNESS(value) {
    this.set({
      ...
      action: "SetSharpness",
      content:
        "<InstanceID>0</InstanceID><DesiredSharpness>" +
        value +
        "</DesiredSharpness>",
    });
  },
  ...
  set COLOR_TEMPERATURE(value) {
    this.set({
      ...
      content:
        "<InstanceID>0</InstanceID><DesiredColorTemperature>" +
        value +
  ...
  set CONTRAST(value) {
    this.set({
      ...
      action: "SetContrast",
      content:
        "<InstanceID>0</InstanceID><DesiredContrast>" +
        value +
        "</DesiredContrast>",
    });
  },
  ...
  set BRIGHTNESS(value) {
    this.set({
      ...
      content:
        "<InstanceID>0</InstanceID><DesiredBrightness>" +
        value +
        "</DesiredBrightness>",
    });
  },
  ...
  set PRESENTS(value) {
    this.set({
      ...
      action: "SelectPreset",
      content:
        "<InstanceID>0</InstanceID><PresetName>" + value + "</PresetName>",
    });
  },
  get PRESENTS() {
    return this.get({
  ...
  set MESSAGE(value) {
    ...
    if (value) {
      ...
      x = {
        action: "AddMessage",
        content:
          "<MessageType>text/xml; charset=&quot;utf-8&quot;</MessageType><Message>" +
          result +
          "</Message>",
      };
    }
