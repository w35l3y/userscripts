...
// @icon           https://gm.wesley.eti.br/icon.php?desc=28821
// ==/UserScript==
...
(function () {
    ...
    queueEvents = queueEvents.jsonGambi(
      {
        ...
        petName: petName[1],
        image: document.evaluate(
          '//img[contains(@src,"https://images.neopets.com/pets/80by80/")]/@src',
          document,
          null,
          XPathResult.STRING_TYPE,
          null
        ).stringValue,
        text: document.body.innerHTML.match(/<p>(.{10,255})<\/p><form/i)[1],
      },
      1,
      queueEvents == "[]" ? "" : ","
    );
  ...
  if (queueEvents != "[]") {
    ...
    resourceText(
      "https://neopets.wesley.eti.br/SecretLaboratory/addEvent.php?type=json",
      function (r) {
