...
// @icon           https://gm.wesley.eti.br/icon.php?desc=54391
...
SDB.list = function (e, onLoadCallback) {
  function convertToObject(xml) {
    var sitems = [];
    var items = xml.evaluate(
      "//td[@class='content']//tr[position()>1 and position()<last()]//input",
      xml,
      null,
    ...
    for (var ai = 0, at = items.snapshotLength; ai < at; ++ai) {
      ...
      var cells = xml.evaluate(
        "./ancestor::tr[1]",
        item,
        null,
        XPathResult.FIRST_ORDERED_NODE_TYPE,
        null
      ).singleNodeValue.cells;
  ...
  if (typeof onLoadCallback != "function")
    ...
    //req.options.headers["Referer"] = "https://www.neopets.com/safetydeposit.phtml?obj_name=&category=0";
    xargs.unshift(
      "GET",
      "https://www.neopets.com/safetydeposit.phtml",
      function (e) {
        var msg = e.responseXML.evaluate(
          "//div[@class='errormess' and b] | //td[@class='content']/p/b",
          e.responseXML,
          null,
          XPathResult.FIRST_ORDERED_NODE_TYPE,
          null
...
SDB.remove = function (items, pin, search, onLoadCallback) {
  ...
  if (typeof pin == "function") {
    ...
    xargs =
      array_slice(arguments, typeof onLoadCallback == "function" ? 3 : 2) || [];
    ...
    xargs =
      array_slice(arguments, typeof onLoadCallback == "function" ? 4 : 3) || [];

  var req = new HttpRequest();
  //req.options.headers["Referer"] = "https://www.neopets.com/safetydeposit.phtml";
  xargs.unshift(
    "POST",
    ...
    function (e) {
      ...
      //	Config...	https://www.neopets.com/safetydeposit.phtml
