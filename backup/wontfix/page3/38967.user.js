// ==UserScript==
// @name           Bux : Browse Ads
// @namespace      https://gm.wesley.eti.br/bux
...
// @icon           https://gm.wesley.eti.br/icon.php?desc=38967
...
w.setAttribute(
  "style",
  "position:fixed; bottom:0px; right:0px; background-color:#000; font-weight:bold; color:#FFF; display:block; padding:4px;"
);
...
close.setAttribute(
  "style",
  "cursor:pointer; margin-left:2px; padding:0px 5px 0px 4px; background-color:#FF0000; display:block; float:right; width:10px;"
);
close.textContent = "×";
...
function surfAds(info, n) {
  ...
  if ((ad = info.ads.snapshotItem(n))) {
    ...
    var h = {
      Referer:
        d +
        ((typeof info.referer[0] == "function" && info.referer[0](tmp.href)) ||
          info.referer[0]),
    };
            ...
            if (!!url) {
              ...
              GM_xmlhttpRequest({
                ...
                onload: function (e) {
                  ...
                  if (/^2/.test(e.status)) info.callback(ad);

                  if (!this.falseNegative) surfAds(info, ++n);
                },
                onerror: function (e) {
                  clearTimeout(force_reload);
                  force_reload = null;
...
switch (document.domain.replace(/^www\d*\./, "")) {
    ...
    surfAds(
      {
        ads: document.evaluate(
          '//a[contains(@href,"view.php?ad=") and text()]',
          document,
          null,
        ...
        callback: function (ad) {
          ad.parentNode.innerHTML =
            '<font style="font-weight: normal;" color="#660000"><strike>' +
            ad.innerHTML +
            "</strike></font>";
        },
      },
  ...
  case "unclebux.com":
    surfAds(
      {
        ads: document.evaluate(
          '//a[contains(@href,"view.php?ad=") and not(contains(translate(text(),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz"),"cheat")) and text()]',
          document,
          null,
          XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
          null
  ...
  case "max-ptc.com":
    surfAds(
      {
        ads: document.evaluate(
          '//a[contains(@href,"view.php?ad=") and ((not(contains(translate(text(),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz"),"cheat")) and text()) or (img/@src and not(contains(translate(img/@src,"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz"),"cheat"))))]',
          document,
          null,
          XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
          null
        ...
        referer: [
          function (u) {
            ...
            else if (/beanybux/i.test(u)) return "/bannersurf.php";
            else if (/10ads/i.test(u)) return "/index.php/surf.php";
            else return "/surf.php";
          },
          function (e) {
            var ad = e.finalUrl.match(/ad=(\d+)/)[1];
            var code = e.responseText.match(/var code\s*=\s*"(\w+)";/)[1];
    ...
    surfAds(
      {
        ...
        referer: [
          function (u) {
            if (/sakul/i.test(u)) return "/bux/surf.php";
            else return "/surf.php";
          },
          function (e) {
            var ad = e.finalUrl.match(/ad=(\d+)/)[1];
            var verify = e.responseText.match(
              /<input type="hidden" name="verify" value="(\w+)">/
            )[1];
        ...
        callback: function (ad) {
          ad.parentNode.innerHTML =
            '<del><font color="blue">' + ad.innerHTML + "</font></del>";
        },
      },
      0
    );
  ...
  case "buxup.com": // time untested
    surfAds(
      {
        ads: document.evaluate(
          '//a[contains(@href,"viewpaid.php?ad=") and not(contains(translate(center/b/text(),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz"),"cheat")) and center/b/text()]',
          document,
          null,
          XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
          null
        ...
        time: 0, // 30
        callback: function (ad) {
          ad.parentNode.parentNode.parentNode.parentNode.setAttribute(
            "class",
            "buxuplinks2"
          );
          ad.setAttribute("href", "#");
          ad.firstChild.innerHTML =
            "<del>" + ad.firstChild.innerHTML + "</del>";
        },
      },
      0
    );
  ...
  case "buxdotcom.com": // time untested
    surfAds(
      {
        ads: document.evaluate(
          '//a[contains(@href,"viehw.php?ad=") and not(contains(translate(text(),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz"),"cheat")) and text()]',
          document,
          null,
          XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
          null
        ...
        time: 30,
        callback: function (ad) {
          ad.parentNode.parentNode.innerHTML =
            "<del>" + ad.innerHTML + "</del>";
        },
      },
      0
    );
  ...
  case "isabelmarco.com":
    surfAds(
      {
        ads: document.evaluate(
          '//a[contains(@href,"?p=view&ad=") and not(contains(translate(text(),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz"),"cheat")) and text()]',
          document,
          null,
          XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
          null
  ...
  case "eurovisits.org": // time untested
    surfAds(
      {
        ads: document.evaluate(
          '//a[contains(@href,"adclick.php?ID=") and not(contains(translate(text(),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz"),"cheat")) and text()]',
          document,
          null,
          XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
          null
    ...
    surfAds(
      {
        ...
        callback: function (ad) {
          ad.parentNode.parentNode.innerHTML =
            '<span style="margin-left: 3px; text-decoration:none; color: #ffffff;"><strike>' +
            ad.innerHTML +
            "</strike></span>";
        },
      },
  ...
  case "buyas.info":
    surfAds(
      {
        ads: document.evaluate(
          '//a[contains(@href,"view.php?ad=") and not(contains(@href,"?ad=11421")) and b[not(contains(translate(text(),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz"),"cheat")) and text()]]',
          document,
          null,
          XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
          null
        ...
        callback: function (ad) {
          ...
          while (!row.cells) row = row.parentNode;
          ...
          ad.parentNode.innerHTML =
            '<font color="#111111">' + ad.firstChild.innerHTML + "</font>";
        },
      },
      0
    );
  ...
  case "perfectbux.com":
    surfAds(
      {
        ads: document.evaluate(
          '//a[contains(@href,"&ad_id=") and not(contains(translate(text(),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz"),"cheat")) and text()]',
          document,
          null,
          XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
          null
        ...
        referer: [
          "/index.php?page=surf-ads",
          function (e) {
            return e.responseText.match(
              /success\.location\.href = '(?:https?:\/\/(?:www\d*\.)?perfectbux\.com)?(.+?)';/
            )[1];
          },
        ],
        time: 0, // 30
  ...
  case "thinkbux.com":
    surfAds(
      {
        ads: document.evaluate(
          '//form[@action="view.php"]/input[@name="ad"]',
          document,
          null,
          XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
          null
        ...
        time: 0, // 25
        callback: function (ad) {
          ad.form.parentNode.innerHTML =
            " &nbsp; <del>" + ad.form.textContent + "</del>";
        },
      },
      0
    );
