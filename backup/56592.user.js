...
// @icon           https://gm.wesley.eti.br/icon.php?desc=56592
...
Course.status = function (
  ...
  if (typeof params.onsuccess != "function") {
    ...
    var msg = params.response.xml.evaluate(
...
Course.start = function (
  params // type, pet, onLoadCallback
) {
  if (!params.type) {
    WinConfig.init({
      type: "error",
    ...
    HttpRequest.open({
      method: "post",
      url: "https://www.neopets.com/island/process_training.phtml",
      onsuccess: function (params) {
        if (typeof params.onsuccess == "function") {
    ...
    HttpRequest.open({
      ...
      onsuccess: function (params) {
        ...
        if (typeof params.onsuccess == "function") {
          var obj = params.parameters || {};
          obj.response = params.response;
          obj.error = /\/process_training\.phtml$/.test(
            params.response.raw.finaUrl
          )
            ? 1
            : 0;
          obj.message = msg;
