...
// @include        nowhere
// @exclude        *
// @icon           https://gm.wesley.eti.br/icon.php?desc=154363
// @grant          GM_log
// @grant          GM_getValue
// @grant          GM_setValue
// @grant          GM_openInTab
...
// @contributor     jellyneo (https://www.jellyneo.net/?go=rereg)
// ==/UserScript==
  ...
  RandomEvents = {
    ...
    process: function (obj) {
      var processEvent = function (obj) {
          var type = obj.type,
            image = obj.image.replace("https://images.neopets.com", ""),
            text = obj.text,
          ...
          for (var b in params) {
            ...
            params[b].parentNode.replaceChild(
          ...
          var str = text.innerHTML
            ...
            loc = location.href
              .substr(location.href.indexOf(location.pathname))
              .replace(RandomEvents.location, ""),
            output2 =
              [
                d.getUTCFullYear(),
                ff(1 + d.getUTCMonth()),
          ...
          b: for (var b in revents) {
            ...
            if (
              /\([^)]+\+\)/.test(event[3]) &&
              (match = new RegExp(event[3]).exec(str))
            ) {
              match.shift();
            ...
            if (str == event[3]) {
              var p = event[4].split(","),
                ppp = [],
                private_params = JSON.parse(
                  GM_getValue("private_params", "[]")
                ),
                sum = -1,
                out = "";
              ...
              for (var c in p) {
                ...
                if (/([+-])/.test(p[c])) {
                  ...
                  if (
                    prefix != pc.substr(0, kk) ||
                    !~psuffix ||
                    suffix != pc.substr(psuffix)
                  ) {
                    continue b;
                  } else if (~pp.indexOf("-")) {
                    var f = -1;
        ...
        events = xpath(
          ".//table[@align = 'center' and @width and tbody/tr[1]/td[1][@bgcolor] and tbody/tr[2]/td[1]/img[1][contains(@src, 'https://images.neopets.com/')]]",
      ...
      events = xpath(
        ".//div[@class = 'inner_wrapper2' and img[contains(@src, '/items/')] and p]",
        obj.document || document
      );
      /*
<div class="pushdown">
	<div class="inner_wrapper">
		<div class="inner_wrapper2">
						...
						<img class="icon" src="https://images.neopets.com/shh/event/water-faerie-1.png">
			<img class="item" src="https://images.neopets.com/items/book_elephant_wings.gif">			<p>A Water Faerie sniffs and says, "You probably won&#39;t help, but I need <b>Little Wings Big Feet</b> for my studies. I can&#39;t tell you why."</p>
		</div>
	</div>
</div>
*/
      ...
      if (output.length) {
        ...
        // https://pastebin.com/ts4kB60q (private paste by guest)
        // https://pastebin.com/qQ9KL8sr
        Content.write({
          key: "random_events",
                  ...
                  decodeURIComponent(
                    text
                      ...
                      .replace(/#/g, function () {
                        ...
                        return (
                          "<strong>" +
                          params[++sum].replace(/([+-])/, function ($0, $1) {
                            var x = p[++sum2];
