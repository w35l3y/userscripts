...
var StampAlbum = function (page) {
  var _this = this,
    ...
    _get = function (data, p, cb) {
      page.request({
        method: "get",
        action: "https://www.neopets.com/stamps.phtml",
        delay: true,
        data: data,
    ...
    (function recursive(p, max) {
      _this.album({
        ...
        callback: function (xhr) {
          pages.push(xhr);
          max = xpath(
            "count(.//td[@class = 'content']//p/a[contains(@href, 'page_id')]/b)",
            xhr.body
          );
      ...
      _get(
        ...
        function (xhr) {
          ...
          return {
            ...
            owner: xpath(
              "string(.//td[@class = 'content']//p/b/a[contains(@href, 'randomfriend')]/b/text())",
              xhr.body
            ),
            name: xpath(
              "string(.//td[@class = 'content']//table/tbody/tr/td/b/text())",
              xhr.body
            ).replace(/-\s+|\s+-/g, ""),
            stamps: xpath(
              ".//td[@class = 'content']//table/tbody/tr/td/img",
              xhr.body
            ).map(function (o) {
              ...
              return {
                position: [
                  o.parentNode.cellIndex,
                  o.parentNode.parentNode.rowIndex - 1,
                ],
                    ...
                    function () {
                      ...
                      r.stamps = r.stamps.map(function (o, i) {
                        var xx = !~o.image.indexOf("no_stamp"),
                          x = xx ? o : r2.stamps[i];
                        x.found =
                          xx | (!~r2.stamps[i].image.indexOf("no_stamp") << 1);
    ...
    _get(
      ...
      function (xhr) {
        return {
          ...
          total: parseInt(
            xpath(
              "string(.//td[@class = 'content']//p[position() = last()]/b/text())",
              xhr.body
            ),
            10
          ),
