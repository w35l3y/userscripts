...
// @version        5.0.3
// @language       en
// @include        https://www.neopets.com/games/cliffhanger/cliffhanger.phtml
// @grant          GM_log
// @grant          GM_addStyle
// @grant          GM_getValue
// @grant          GM_setValue
...
// @icon           https://gm.wesley.eti.br/icon.php?desc=28760
...
// @contributor    skyknight920 (https://www.angelfire.com/games5/skgames/guides/cliffhangeranswers.html)
// @contributor    acara227910 (https://www.neopets.com/~acara227910)
// @contributor    cnwcentral (https://www.cnwcentral.com/neopets/neopets-cliffhanger-answers/)
// @contributor    Quagthistle (https://quagthistle.org/neopets/Games/CliffhangerTable.html)
// @cfu:version    version
// @history        5.0.0 Added <a href="https://userscripts.org/guides/773">Includes Checker</a>
...
(function () {
  ...
  (function recursive(obj) {
    var skill = xpath(
      ".//form[contains(@action, 'process_cliffhanger.phtml')]/input[@name = 'game_skill' and @value = '3']"
    )[0];
    ...
    if (skill) {
      ...
      if (answers.length) {
        var pattern = new RegExp(
            "^" +
              xpath(
                ".//tbody/tr/td[@bgcolor= 'skyblue' and @colspan = '2' and contains(b/text(), '_')]"
              )[0]
                .innerHTML.replace(/<br>/g, "&nbsp;")
                .replace(/\s+|<(?:\/?\w+|\w+(?:\s+\w+="\w+")+)>/g, "")
                .replace(/_/g, "\\w")
                .replace(/(?:&nbsp;|<br(?: *\/?)>)/g, " ")
                .replace(/^\s+|\s+$/g, "") +
              "$",
        ...
        if (1 < t || !options.at_once) {
          var letters = xpath(
              ".//a[contains(@href, 'process_cliffhanger.phtml?choice=') and b]"
            ).sort(function () {
        ...
        if (t == 1) {
          var solve = xpath(
            ".//form[contains(@action, 'process_cliffhanger.phtml')]/input[@name = 'solve_puzzle']"
          )[0];
    ...
    source: [
      [
        "https://www.angelfire.com/games5/skgames/guides/cliffhangeranswers.html",
        ".//font/p/text()",
      ],
      ["https://www.neopets.com/~acara227910", ".//b/font/p/text()"],
      [
        "https://www.cnwcentral.com/neopets/neopets-cliffhanger-answers/",
        "id('content')/article/div/ul/li/text()",
      ],
      [
        "https://quagthistle.org/neopets/Games/CliffhangerTable.html",
        ".//td[2]/text()",
      ],
    ],
  });
