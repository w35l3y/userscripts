...
// @icon           https://gm.wesley.eti.br/icon.php?desc=112692
// @connect        neopets.com
// @connect        github.com
...
// @contributor    nozkfox
// @history        4.7.0 Updated required files (pastebin nevermore)
...
(function () {
            ...
            change: function (e) {
              if (e.target.checked) {
                if (
                  0x1 & e.target.value &&
                  !confirm(
                    "All prices will be checked only once while pricing items. Continue?"
                  )
                ) {
                  ...
                  0x2 & e.target.value &&
                  !confirm(
                    "All items will be bought once items are priced. Continue?"
                  )
                ) {
                  e.target.checked = false;
                }
          ...
          fields: [
            {
              ...
              value: [
                ...
                },
                {
                  ...
                  description:
                    '<a href="/closet.phtml">Closet</a><br /><a href="/safetydeposit.phtml">Safety Deposit Box</a>',
                  help: true,
                },
                {
                  value: 0x0008,
                  ...
                  description:
                    '<a href="/faerieland/employ/employment.phtml">Faerieland Employment Agency</a>',
                  help: true,
                },
                {
                  value: 0x0010,
                  label: "Shop Stock",
                  description:
                    '<a href="/market.phtml?type=your">Shop Stock</a>',
                  help: true,
                },
                {
                  value: 0x0020,
                  ...
                  title: "Faerie Quests",
                  description:
                    '<a href="/quests.phtml">Random Faerie Quests</a>',
                  help: true,
                },
                {
                  value: 0x0040,
                  ...
                  description:
                    '<a href="/auctions.phtml">Neopian Auction House</a>',
                  help: true,
                },
                {
                  value: 0x0080,
                  label: "Trading Post",
                  description:
                    '<a href="/island/tradingpost.phtml">Trading Post</a>',
                  help: true,
                },
                {
                  value: 0x0100,
                  ...
                  description:
                    '<a href="/pirates/academy.phtml">Cap\'n Threelegs\' Swashbuckling Academy</a><br /><a href="/island/training.phtml">Mystery Island Training School</a><br /><a href="/island/fight_training.phtml">Secret Ninja Training School</a>',
                  help: true,
                },
                {
                  value: 0x0200,
                  label: "Kadoatery",
                  description:
                    '<a href="/games/kadoatery/index.phtml">The Kadoatery</a>',
                  help: true,
                },
                {
                  value: 0x0400,
                  label: "Neopian Shop",
                  description:
                    '<a href="/objects.phtml?type=shop">Neopian Shops</a>',
                  help: true,
                },
                {
                  value: 0x0800,
                  ...
                  title: "Quests",
                  description:
                    '<a href="/island/kitchen.phtml">Mystery Island Kitchen</a><br /><a href="/halloween/esophagor.phtml">The Esophagor</a><br /><a href="/winter/snowfaerie.phtml">The Snow Faerie\'s Quest</a><br /><a href="/halloween/witchtower.phtml">The Witch\'s Tower</a>',
                  help: true,
                },
                {
                  value: 0x1000,
                ...
                },
                {
                  ...
                  description:
                    '<a href="/halloween/garage.phtml">Almost Abandoned Attic</a>',
                  help: true,
                },
                {
                  value: 0x4000,
                  ...
                  description:
                    '<a href="/winter/igloo2.phtml">Igloo Garage Sale</a>',
                  help: true,
                },
                {
                  value: 0x8000,
                  ...
                  description:
                    '<a href="/space/coincidence.phtml">Aboard The Coincidence</a>',
                  help: true,
                },
              ],
            },
            ...
            },
            {
              ...
              value: [
                ...
                },
                {
                  ...
                  help: true,
                  description:
                    "Shows the list of groups visited.<br />The most recent group is at first.<br /><br />-1 means not found.<br /><br /><b>Groups:</b> AN0, BO1, CP2, DQ3, ER4, FS5, GT6, HU7, IV8, JW9, KX_, LY and MZ.<br /><br /><b>Example:</b> 5, -1, -1, 0",
                },
                {
                  value: 2,
                  label: "Total",
              ...
              fields: [
                {
                  ...
                  label: "Item",
                  description:
                    "NP Limit by item price.<br />NP Limit is checked only after auto pricing is executed.<br /><br /><sup>You may set 0 to ignore this limit.</sup>",
                  format: WinConfig.FieldFormat.NUMBER,
                  help: true,
                  empty: 0,
                },
                {
                  ...
                  label: "Total",
                  description:
                    "NP Limit by total price.<br />NP Limit is checked only after auto pricing is executed.<br /><br /><sup>You may set 0 to ignore this limit.</sup>",
                  format: WinConfig.FieldFormat.NUMBER,
                  help: true,
                  empty: 0,
                },
          ...
          fields: [
            {
              ...
              format: WinConfig.FieldFormat.NUMBER,
              description:
                "Locations where auto pricing should be enabled.<br /><br /><sub>This field is multiselect, hold Ctrl to select multiple options.</sub>",
              multiple: true,
              unique: true,
              empty: 0,
              help: true,
            ...
            },
            {
              ...
              description:
                "Default position of the $ sign (append or prepend).",
              multiple: true,
              help: true,
            },
            {
              ...
              description:
                "Uses the Super Shop Wizard when checked.<br /><br /><sup><b>Premium Only</b></sup>",
              multiple: true,
              help: true,
              events: {
                change: function (e) {
            ...
            },
            {
              ...
              description:
                'It disables autopricing in some cases.<br /><br />For example, when you: <ul><li>just completed a <a href="/quests.phtml">Faerie Quest</a></li><li> are looking for <a href="/halloween/witchtower.phtml">Edna avatar</a> (3 items)</li></ul>',
              multiple: true,
              help: true,
              events: {
                change: function (e) {
            ...
            },
            {
              ...
              title: "PIN Number",
              description:
                "Your PIN Number<br />Leave it blank when not used.<br /><br /><sub>It will be used at Bank and SDB.</sub>",
            ...
            },
            {
              ...
              label: "Attempts",
              description:
                "Number of consecutive attempts for each item.<br /><br /><sub>Ignored when SSW is checked.</sub>",
              format: WinConfig.FieldFormat.NUMBER,
              help: true,
              empty: 0,
              attrs: {
  ...
  obj = (function () {
    switch (location.pathname) {
      ...
      case "/objects.phtml":
        switch (
          (/type=(\w+)/.test(location.search) && RegExp.$1) ||
          "inventory"
        ) {
          case "inventory":
            return {
      ...
      case "/quests.phtml":
        return {
          ...
          ignore: function (doc, items) {
            return (
              xpath("boolean(id('complete_faerie_quest'))", doc) ||
              xpath("boolean(.//img[contains(@src, '/crafting-faerie')])")
            );
          },
        };
      case "/auctions.phtml":
  ...
  if (config && obj && obj.key & config.enable) {
    ...
    (_w = function () {
        ...
        setTimeout(Shop.list, _w(), {
          ...
          onsuccess: function (result) {
            if (result.error) {
              ...
              result.list.length &&
              result.list[0].Id == _this.previous.Id
            ) {
        ...
        this.click = function (evt, n) {
          ...
          Wizard.find({
            ...
            onsuccess: function (params) {
              var currentGroup = params.list.length
              ...
              if (1 == config.nGroup) {
                ...
                _this.target.title =
                  _this.name + " (" + _this.groups.length + " groups)";
              }
              ...
              if (params.error) {
                ...
                (!("id" in obj) ||
                  ((obj.id[1] || /(\d+)/).test(
                    xpath(obj.id[0], _this.parent)
                  ) &&
                    RegExp.$1 == params.list[0].Id)) &&
                (evt.altKey ||
                  !_this.previous ||
                  params.list[0].Price <= _this.previous.Price)
              ) {
                _this.target.nextElementSibling.innerHTML =
                  '<a target="' +
                  config.target +
                  '" href="' +
                  params.list[0].Link +
                  (!obj.relative ? '" style="position: absolute;' : "") +
                  '">' +
                  params.list[0].Price +
                  "</a>";
              ...
              if (
                ...
                (!params.error ||
                  confirm(
                    "An error occurred but you may try to buy the current item. Continue?"
                  ))
              ) {
                buy(_this);
              ...
              _this.target.style.color =
                /^2/.test(params.response.raw.status) && !params.error
                  ? "#008800"
                  : "#CC0000";
      ...
      (executeWithdraw = function (list) {
        ...
        var sum = 0,
          hand = parseInt(
            xpath("string(id('npanchor'))").replace(/[,.]/g, ""),
            10
          );
        ...
        if (
          ...
          (2 == config.withdraw ||
            (1 == config.withdraw &&
              window.confirm("Withdraw " + sum + " NP?")))
        ) {
          Bank.withdraw({
        ...
        if (b || window.confirm("Confirm auto buying the priced items?")) {
          ...
          (function (list) {
            if (
              2 == config.checkSdb ||
              (1 == config.checkSdb &&
                confirm("Check and remove items from SDB?"))
            ) {
              var sdbList = [];
                    ...
                    onsuccess: function (obj) {
                      if (obj.list.length) {
                        for (var ai in obj.list) {
                          if (
                            obj.list[ai].Name.toLowerCase() == list[index][0] &&
                            obj.list[ai].Quantity >= list[index][1]
                          ) {
      ...
      (autoprice = function (e) {
        if (wait) {
          ...
          var attempts =
            e.altKey || config.isSuper
              ? 1
              : parseInt(
                  window.prompt(
                    "How many times to search for lowest prices?",
                    config.attempts
                  ),
                  10
                );
                ...
                if (e.ctrlKey && testBuy()) {
                  ...
                  if (tBuy) {
                    if (config.npLimit.total && sum > config.npLimit.total) {
                      alert(
                        "NP Limit exceeded! (Total " +
                          sum +
                          " > " +
                          config.npLimit.total +
                          ")"
                      );
                    } else {
                      executeBuy(false);
    ...
    for (var ai in list) {
      ...
      block.innerHTML =
        '<span class="dollar_button" title="' +
        item.textContent.replace(/[">&]/g, function ($0) {
    ...
    if (
      obj.key & config.autopricing &&
      listButtons.length &&
      (!obj.ignore || (config.ignore && !obj.ignore(doc, list)))
    ) {
